...
//___/
	 ...
	 * toma el array de los atributos y lo desordena para luego a�adir todos sus elementos en una pila
	 */
	public PilaEventos() {
	...
	/**
	 * Este m�todo a�ade un nodo de primero (cada nodo es un evento)
	 * @param int tipo, corresponde al tipo de evento que se quiere crear
	 * La lista de tipo de evento se encuentra en el m�todo ejecutarTipo()
	 */
